...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \Dsaga\Admin\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('Dsaga\Admin\AdminServiceProvider');
    ...
    public function setUp()
    {
        ...
        $this->artisan('vendor:publish', ['--provider' => 'Dsaga\Admin\AdminServiceProvider']);
