...
use Dsaga\Admin\Grid\Column;
use Dsaga\Admin\Grid\Displayers\Actions;
use Dsaga\Admin\Grid\Displayers\RowSelector;
use Dsaga\Admin\Grid\Exporter;
use Dsaga\Admin\Grid\Filter;
use Dsaga\Admin\Grid\Model;
use Dsaga\Admin\Grid\Row;
use Dsaga\Admin\Grid\Tools;
...
class Grid
{
    ...
    {
        $map = [
            'editable'    => \Dsaga\Admin\Grid\Displayers\Editable::class,
            'switch'      => \Dsaga\Admin\Grid\Displayers\SwitchDisplay::class,
            'switchGroup' => \Dsaga\Admin\Grid\Displayers\SwitchGroup::class,
            'select'      => \Dsaga\Admin\Grid\Displayers\Select::class,
            'image'       => \Dsaga\Admin\Grid\Displayers\Image::class,
            'label'       => \Dsaga\Admin\Grid\Displayers\Label::class,
            'button'      => \Dsaga\Admin\Grid\Displayers\Button::class,
            'link'        => \Dsaga\Admin\Grid\Displayers\Link::class,
            'badge'       => \Dsaga\Admin\Grid\Displayers\Badge::class,
            'progressBar' => \Dsaga\Admin\Grid\Displayers\ProgressBar::class,
            'radio'       => \Dsaga\Admin\Grid\Displayers\Radio::class,
            'checkbox'    => \Dsaga\Admin\Grid\Displayers\Checkbox::class,
            'orderable'   => \Dsaga\Admin\Grid\Displayers\Orderable::class,
        ];
